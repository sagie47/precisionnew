  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        setFormState('idle');
        alert("Submission failed. Please try calling us directly at 250.551.3471.");
      }
    } catch (error) {
      console.error("Network error submitting form:", error);
      setFormState('idle');
      alert("Network error. Please check your connection or call us directly at 250.551.3471.");
    }
